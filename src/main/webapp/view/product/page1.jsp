    ...
    <div class="content">
        ...
        <div class="product">
            ...
            <div class="product-info">
                <h3>Americano</h3>
                <p>The aroma of our Americano brewed with premium roasted coffee grounds
                    and hot water. It has a velvety body, caramel-like aroma with an earthy
                    flavour and bittersweet finish.</p>
        ...
        <div class="product">
            ...
            <div class="product-info">
                <h3>Cappuccino</h3>
                <p>With the richness and intensity of espresso, complemented by the creamy and
                    velvety texture of steamed milk, offering a combination of strong coffee notes,
                    subtle sweetness, and a touch of bitterness.</p>
                <div class="price-cart">
                    <div class="price">40.000₫</div>
                    <button class="btn">Add to Cart</button>
                </div>
