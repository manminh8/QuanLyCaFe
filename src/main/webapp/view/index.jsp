<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="model.TaiKhoanNguoiDung"%>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8" />
	...
	<header>
		...
		<nav>
			<a href="product/page1.jsp">Sản phẩm</a> <a
				href="../view/shoppingcart/shopping_cart.jsp">Giỏ hàng</a>  <%
        model.TaiKhoanNguoiDung user = (model.TaiKhoanNguoiDung) session.getAttribute("user");
        if (user != null) {
    %>
        <a href="../view/xulyphanlogin/logout.jsp">Đăng xuất</a>
    <%
        } else {
    %>
        <a href="../view/xulyphanlogin/login.jsp">Đăng nhập</a>
    <%
        }
    %>
		</nav>
	...
	<section class="hero">
		<div class="hero-text">
			...
			<button onclick="window.location.href='product/page1.jsp'"
				class="shop-button">Shop All Products ></button>
		</div>
	</section>
